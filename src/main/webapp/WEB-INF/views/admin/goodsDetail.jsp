...
<link rel="stylesheet" href="../resources/css/admin/goodsDetail.css?ver19">
<script
				...
				<%@include file= "../includes/admin/adminHeader.jsp"%>
                    ...
                    <div class="admin_content_main">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="publicYear" autocomplete="off" readonly="readonly" value="<c:out value="${goodsInfo.publicYear}"/>" disabled>                    				
                    			</div>
                    		</div> 
