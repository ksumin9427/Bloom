...
<body>
	...
	<script>
		...
		$(document).ready(function(){
			...
			/* 캘린더 */
			$(function() {
				let publicYear = '${goodsInfo.publicYear}';
				let puble_length = publicYear.indexOf(" ");
				publicYear = publicYear.substring(0, puble_length);
				$( "input[name='publicYear']" ).datepicker(config);
				$( "input[name='publicYear']" ).datepicker('setDate', publicYear);
			});				
