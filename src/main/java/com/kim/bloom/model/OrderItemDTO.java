...
public class OrderItemDTO {
    ...
    public String toString() {
    	return  "OrderItemDTO [orderId=" + orderId + ", bookId=" + bookId + ", bookCount=" + bookCount + ", orderItemId=" +orderItemId 
				+ ", bookPrice=" + bookPrice + ", bookDiscount=" + bookDiscount + ", savePoint="+savePoint+", salePrice=" + salePrice
